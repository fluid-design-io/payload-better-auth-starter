...
const features = [
  ...
  },
  {
    ...
    description:
      "Built-in email templates for consistent and professional communication.",
  },
  {
    icon: Palette,
  ...
  },
  {
    ...
    title: "Admin UI",
    description:
      "Prettified Payload Admin UI for a better content management experience.",
  },
  {
    icon: Zap,
  ...
  },
  {
    ...
    title: "Form Plugin",
    description:
      "Optional Payload Form Plugin Renderer for rendering forms in the frontend.",
  },
  {
    icon: Ship,
    title: "Docker Development",
    description:
      "Full-suite local development with S3, inbucket, and postgres in one command.",
  },
];
    ...
    <Container asChild>
      <AnimatedGroup className='grid grid-cols-1 gap-4 md:grid-cols-2 lg:grid-cols-3'>
        {features.map((feature) => (
          <Card
            variant='muted'
            className='overflow-hidden p-6 h-full'
            key={feature.title}
          >

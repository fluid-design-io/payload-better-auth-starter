			...
			<div className={CLASSNAMES.layoutPadding}>
				<Container className="py-16 sm:pt-24">
					<div className="flex items-center justify-between gap-8">
						<AcmeLogoIcon className="text-muted-foreground h-7 w-auto" />
						<ThemeSelector />
					</div>
					...
					{!footerText && (
						<P className="text-muted-foreground/60 mt-6 text-center text-xs leading-5 md:text-left [&_a]:underline">
